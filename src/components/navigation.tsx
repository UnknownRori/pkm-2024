...
export default function Navigation() {
  ...
  return (
    <nav className="relative flex gap-8 shadow py-4 px-8">
      <div className="flex-initial flex sm:w-full md:w-auto justify-between items-center">
        <h1 className="text-2xl font-bold">UMKM Logo</h1>

        <HamburgerButton onClick={open} state={expanded}></HamburgerButton>
      </div>
      <div className="md:flex sm:absolute md:relative flex-auto bg-white 
        shadow top-0 left-0 sm:w-full md:w-auto md:translate-y-0 sm:translate-y-16">
